...
<head>
  ...
  <![endif]-->
	...
	<script src="<?=BASE_URL_ADMIN?>assets/admin/js/admin.js"></script>
</head>
...
<section>
  ...
  <div class="leftpanel">        
    <div class="leftpanelinner">      
      ...
      <ul class="nav nav-pills nav-stacked nav-bracket">
        <li <?=($segment==''||$segment=='quiz')?'class="active"':''?>><a href="<?=BASE_URL_ADMIN?>admin/quiz"><i class="fa fa-plus"></i> <span>Novo quiz</span></a></li>
		
        <li <?=($segment=='listar')?'class="active"':''?>><a href="<?=BASE_URL_ADMIN?>admin/listar"><i class="fa fa-list"></i> <span>Listar quiz</span></a></li>
        <li><a href="<?=BASE_URL_ADMIN?>admin/logout" onclick="return confirm('Tem certeza que deseja sair do painel?')"><i class="fa fa-sign-out"></i> <span>Sair</span></a></li>
      </ul>      
    </div><!-- leftpanelinner -->
  </div><!-- leftpanel -->
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      <h2><i class="fa fa-home"></i> Painel do administrador</h2>
    </div>