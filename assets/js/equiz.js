...
$.ajax({url:BASE_URL+"quiz/resultado/"+ID_QUIZ+'/?cache='+Math.floor(Math.random()*999999),type:'POST',data:encodeURIComponent(JSON.stringify(data)),dataType:'json',contentType:"application/json; charset=utf-8",beforeSend:function(){$('#quiz #loading').show();$('#quiz .quiz-questions').fadeOut(200,function(){$('#quiz .quiz-result').fadeIn(200);});$('html, body').animate({scrollTop:$("#quiz").offset().top},300);},success:function(msg){
